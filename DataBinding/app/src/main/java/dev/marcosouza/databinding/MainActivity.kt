...
class MainActivity : AppCompatActivity() {
    ...
    private fun updateLikes() {
        ...
        val color = changeAssociatedColor(viewModel.popularity, this)

        ImageViewCompat.setImageTintList(image, ColorStateList.valueOf(color))

        image.setImageDrawable(changeIconByPopularity(viewModel.popularity, this))
    }
    ...
    private fun changeIconByPopularity(popularity: Popularity, context: Context): Drawable? {
        return when (popularity) {
            Popularity.NORMAL -> {
